...
export const articles: Article[] = [
  ...
  },
  {
    ...
    excerpt:
      "The Grand Canyon reveals Earth’s history through its layered rock and stunning scale.",
    content: `Carved by the Colorado River, this natural wonder is one of the most visited parks in the U.S.`,
    url: "https://www.britannica.com/place/Grand-Canyon-National-Park",
  },
  {
    id: "12",
    origin: "default",
